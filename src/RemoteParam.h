...
enum RemoteUICallClientAction{
	...
	//group presets
	SERVER_GROUP_SAVED_PRESET, SERVER_DID_SET_GROUP_PRESET, SERVER_DELETED_GROUP_PRESET
};
...
enum RemoteUICallServerAction{
	...
	//group presets
	CLIENT_DID_SET_GRUP_PRESET, CLIENT_SAVED_GROUP_PRESET, CLIENT_DELETED_GROUP_PRESET
};
