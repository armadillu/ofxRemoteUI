...
#define OFXREMOTEUI_BROADCAST_PORT			10101
#define OFXREMOTEUI_BORADCAST_INTERVAL		0.5 /*secs*/
#define OFXREMOTEUI_DEATH_BY_TIME			1.5 /*sec*/
#define OFXREMOTEUI_NOTIFICATION_SCREENTIME	2.0


#define OFXREMOTEUI_LATENCY_TEST_RATE		0.3333
#define OFXREMOTEUI_CONNECTION_TIMEOUT		5.0f
