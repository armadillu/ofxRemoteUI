//
//  ofxRemoteUISimpleNotifications.cpp
//  emptyExample
//
...
void ofxRemoteUISimpleNotifications::update(float dt){
...
void ofxRemoteUISimpleNotifications::draw(float x, float y){
...
void ofxRemoteUISimpleNotifications::addNotification(const string & msg){
...
void ofxRemoteUISimpleNotifications::addLogLine(const string & msg, bool merge){
...
void ofxRemoteUISimpleNotifications::addParamUpdate(const string & paramName, const RemoteUIParam & p, const ofColor & bgColor, const ofColor & paramC){
	ParamNotification n;
	n.color = paramC;
	n.bgColor = bgColor;
...
void ofxRemoteUISimpleNotifications::addParamWatch(const string &paramName, const  string& paramValue, const ofColor & paramC){
	ParamNotification n;
	n.color = paramC;
	n.bgColor = ofColor(0);
	n.value = paramValue;
...
void ofxRemoteUISimpleNotifications::removeParamWatch(const string & paramName){
...
void ofxRemoteUISimpleNotifications::removeAllParamWatches(){
	paramWatch.clear();
	paramWatchOrder.clear();
}

void ofxRemoteUISimpleNotifications::addVariableWatch(const string &paramName, const string& paramValue, const ofColor & paramC){
	ParamNotification n;
	n.color = paramC;
...
#ifdef USE_OFX_FONTSTASH
void ofxRemoteUISimpleNotifications::drawUiWithFontStash(ofxFontStash * font_){
...
#ifdef USE_OFX_FONTSTASH2
void ofxRemoteUISimpleNotifications::drawUiWithFontStash2(ofxFontStash2::Fonts * font2_){
	fontRenderer = RENDER_WITH_OFXFONTSTASH2;
	font2 = font2_;
}
#endif

void ofxRemoteUISimpleNotifications::drawUiWithBitmapFont(){
	fontRenderer = RENDER_WITH_OF_BITMAP_FONT;
}

void ofxRemoteUISimpleNotifications::setNotificationScreenTime(float t){
	screenTime = t;
}

void ofxRemoteUISimpleNotifications::setLogNotificationScreenTime(float t){
	logScreenTime = t;
}

float ofxRemoteUISimpleNotifications::drawStringWithBox(const string & text, int x, int y, const ofColor& background, const ofColor& foreground, float fontSize, float lineH){
